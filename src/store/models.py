...
class Product(models.Model):
    ...
    category = models.ForeignKey('Filter', on_delete=models.CASCADE, related_name='filter_category', blank=True)
    type = models.ForeignKey('Filter', on_delete=models.CASCADE, related_name='filter_type', blank=True)
    tag = models.ForeignKey('Filter', on_delete=models.CASCADE, related_name='filter_tag', blank=True)
