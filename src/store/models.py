...
class Product(models.Model):
    ...
    get_category = models.ForeignKey('Filter', on_delete=models.CASCADE, related_name='category')
    get_type = models.ForeignKey('Filter', on_delete=models.CASCADE, related_name='type')
    get_tag = models.ForeignKey('Filter', on_delete=models.CASCADE, related_name='tag')
