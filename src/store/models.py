...
class Product(models.Model):
    ...
    category = models.ForeignKey('Filter', on_delete=models.CASCADE, related_name='category')
    type = models.ForeignKey('Filter', on_delete=models.CASCADE, related_name='type')
    tag = models.ForeignKey('Filter', on_delete=models.CASCADE, related_name='tag')
