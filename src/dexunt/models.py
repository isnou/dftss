...
class Item(models.Model):
    ...
    shoe_size = models.ManyToManyField(Shoe, on_delete=models.CASCADE, blank=True, null=True)
    clothing_size = models.ManyToManyField(Clothing, on_delete=models.CASCADE, blank=True, null=True)
    color = models.ManyToManyField(Color, on_delete=models.CASCADE, blank=True, null=True)
    option = models.ManyToManyField(Option, on_delete=models.CASCADE, blank=True, null=True)
