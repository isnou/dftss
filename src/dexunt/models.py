...
class ItemImage(models.Model):
    album_name = models.CharField(max_length=200, blank=True, default='item-image')
...
class PreOrder(models.Model):
    ...
    product_id = models.DecimalField(max_digits=20, decimal_places=0, blank=True, null=True)
