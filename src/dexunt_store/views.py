...
def product_detail(request, product_id):
    ...
    related_products = Product.objects.all().filter(Q(category=category) | Q(sub_category=sub_category) | Q(tag=tag) | Q(category=category) | Q(sub_category=category)).exclude(id=product_id)
